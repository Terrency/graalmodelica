...
public class ModelicaObject extends DynamicObject {
    public final DynamicObject prototype;
    public ModelicaObject(Shape shape, DynamicObject prototype){
        super(shape);
    ...
    @ExportMessage
    Object toDisplayString(boolean allowSideEffects) { return this.toString(); }
