...
function_arguments
   : function_argument (',' function_arguments_non_first | 'for' for_indices)?
   | named_arguments
   ;

function_arguments_non_first
	: function_argument ( ',' function_argument )* (',' named_arguments)?
	| named_arguments
	;

array_arguments
	: expression ( ',' expression ( ',' expression )* | 'for' for_indices)?
	;
